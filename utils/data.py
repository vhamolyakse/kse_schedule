            ...
            try:
                ...
                if num == reschedule_lesson_id:
                    ...
                    lesson = Lesson(row['id'], row['subject'],
                                    Teacher(row['teacher'], self.teachers_availability[row['teacher']]), teacher_id,
                                    row['is_lection'], group, students_df.shape[0], group_intersection=self.group_intersection,
